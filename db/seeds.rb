...
task1 = Task.create!(text: 'Do something', story: story1)
task2 = Task.create!(text: 'Do something', story: story1)
task3 = Task.create!(text: 'Do something', story: story1)
task4 = Task.create!(text: 'Do something', story: story2)
task5 = Task.create!(text: 'Do something', story: story2)
task6 = Task.create!(text: 'Do something', story: story2)
task7 = Task.create!(text: 'Do something', story: story3)
task9 = Task.create!(text: 'Do something', story: story3)
task10 = Task.create!(text: 'Do something', story: story3)
task11 = Task.create!(text: 'Do something', story: story4)
task12 = Task.create!(text: 'Do something', story: story4)
task13 = Task.create!(text: 'Do something', story: story4)
task14 = Task.create!(text: 'Do something', story: story4)
task15 = Task.create!(text: 'Do something', story: story4)
