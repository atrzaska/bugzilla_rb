...
story1 = Story.create(name: 'Story 1', project: project1, state: 'unstarted', description: 'description', story_type: 'feature', container: 'icebox')
story2 = Story.create(name: 'Story 2', project: project1, state: 'unstarted', description: 'description', story_type: 'feature', container: 'icebox')
story3 = Story.create(name: 'Story 3', project: project1, state: 'unstarted', description: 'description', story_type: 'feature', container: 'icebox')
story4 = Story.create(name: 'Story 4', project: project1, state: 'unstarted', description: 'description', story_type: 'feature', container: 'icebox')
story5 = Story.create(name: 'Story 5', project: project1, state: 'unstarted', description: 'description', story_type: 'feature', container: 'icebox')
story6 = Story.create(name: 'Story 6', project: project2, state: 'unstarted', description: 'description', story_type: 'feature', container: 'icebox')
story7 = Story.create(name: 'Story 7', project: project2, state: 'unstarted', description: 'description', story_type: 'feature', container: 'icebox')
story8 = Story.create(name: 'Story 8', project: project2, state: 'unstarted', description: 'description', story_type: 'feature', container: 'icebox')
story9 = Story.create(name: 'Story 9', project: project2, state: 'unstarted', description: 'description', story_type: 'feature', container: 'icebox')
